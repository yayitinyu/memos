...
export type UserSetting = Message<"memos.api.v1.UserSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.UserSetting.RefreshTokensSetting refresh_tokens_setting = 6;
     */
    value: UserSetting_RefreshTokensSetting;
 ...
 *
 * @generated from message memos.api.v1.UserSetting.RefreshTokensSetting
 */
export type UserSetting_RefreshTokensSetting = Message<"memos.api.v1.UserSetting.RefreshTokensSetting"> & {
  /**
   * List of refresh tokens.
   *
   * @generated from field: repeated memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken refresh_tokens = 1;
   */
  refreshTokens: UserSetting_RefreshTokensSetting_RefreshToken[];
};

/**
 * Describes the message memos.api.v1.UserSetting.RefreshTokensSetting.
 * Use `create(UserSetting_RefreshTokensSettingSchema)` to create a new message.
 */
export const UserSetting_RefreshTokensSettingSchema: GenMessage<UserSetting_RefreshTokensSetting> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 11, 2);

/**
 * @generated from message memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken
 */
export type UserSetting_RefreshTokensSetting_RefreshToken = Message<"memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken"> & {
  /**
   ...
   *
   * @generated from field: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo client_info = 4;
   */
  clientInfo?: UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo | undefined;
...
/**
 * Describes the message memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.
 * Use `create(UserSetting_RefreshTokensSetting_RefreshTokenSchema)` to create a new message.
 */
export const UserSetting_RefreshTokensSetting_RefreshTokenSchema: GenMessage<UserSetting_RefreshTokensSetting_RefreshToken> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 11, 2, 0);

/**
 * @generated from message memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo
 */
export type UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo = Message<"memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo"> & {
  /**
...
/**
 * Describes the message memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo.
 * Use `create(UserSetting_RefreshTokensSetting_RefreshToken_ClientInfoSchema)` to create a new message.
 */
export const UserSetting_RefreshTokensSetting_RefreshToken_ClientInfoSchema: GenMessage<UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 11, 2, 0, 0);
...
export const UserNotification_StatusSchema: GenEnum<UserNotification_Status> = /*@__PURE__*/
  enumDesc(file_api_v1_user_service, 34, 0);
...
export const UserNotification_TypeSchema: GenEnum<UserNotification_Type> = /*@__PURE__*/
  enumDesc(file_api_v1_user_service, 34, 1);
