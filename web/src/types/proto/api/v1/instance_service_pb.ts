...
export const file_api_v1_instance_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_annotations, file_google_api_client, file_google_api_field_behavior, file_google_api_resource, file_google_protobuf_field_mask]);
...
export type InstanceSetting_GeneralSetting = Message<"memos.api.v1.InstanceSetting.GeneralSetting"> & {
   ...
   *
   * @generated from field: memos.api.v1.InstanceSetting.GeneralSetting.LegalNotice legal_notice = 10;
   */
  legalNotice?: InstanceSetting_GeneralSetting_LegalNotice | undefined;
};
 ...
 *
 * @generated from message memos.api.v1.InstanceSetting.GeneralSetting.LegalNotice
 */
export type InstanceSetting_GeneralSetting_LegalNotice = Message<"memos.api.v1.InstanceSetting.GeneralSetting.LegalNotice"> & {
  /**
   * @generated from field: bool display_icp_filing = 1;
   */
  displayIcpFiling: boolean;

  /**
   * @generated from field: string icp_filing_number = 2;
   */
  icpFilingNumber: string;

  /**
   * @generated from field: string icp_filing_url = 3;
   */
  icpFilingUrl: string;

  /**
   * @generated from field: bool display_public_security_filing = 4;
   */
  displayPublicSecurityFiling: boolean;

  /**
   * @generated from field: string public_security_filing_number = 5;
   */
  publicSecurityFilingNumber: string;

  /**
   * @generated from field: string public_security_filing_url = 6;
   */
  publicSecurityFilingUrl: string;
};

/**
 * Describes the message memos.api.v1.InstanceSetting.GeneralSetting.LegalNotice.
 * Use `create(InstanceSetting_GeneralSetting_LegalNoticeSchema)` to create a new message.
 */
export const InstanceSetting_GeneralSetting_LegalNoticeSchema: GenMessage<InstanceSetting_GeneralSetting_LegalNotice> = /*@__PURE__*/
  messageDesc(file_api_v1_instance_service, 2, 0, 1);
