...
const (
	...
	// REFRESH_TOKENS is the key for refresh tokens.
...
func (UserNotification_Status) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{34, 0}
}
...
func (UserNotification_Type) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{34, 1}
}
...
type UserSetting struct {
	...
	//	*UserSetting_RefreshTokensSetting_
...
func (x *UserSetting) GetRefreshTokensSetting() *UserSetting_RefreshTokensSetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_RefreshTokensSetting_); ok {
			return x.RefreshTokensSetting
		}
	}
	return nil
}
...
type UserSetting_RefreshTokensSetting_ struct {
	RefreshTokensSetting *UserSetting_RefreshTokensSetting `protobuf:"bytes,6,opt,name=refresh_tokens_setting,json=refreshTokensSetting,proto3,oneof"`
}
...
func (*UserSetting_RefreshTokensSetting_) isUserSetting_Value() {}
...
type UserSetting_RefreshTokensSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// List of refresh tokens.
	RefreshTokens []*UserSetting_RefreshTokensSetting_RefreshToken `protobuf:"bytes,1,rep,name=refresh_tokens,json=refreshTokens,proto3" json:"refresh_tokens,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserSetting_RefreshTokensSetting) Reset() {
	*x = UserSetting_RefreshTokensSetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_RefreshTokensSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_RefreshTokensSetting) ProtoMessage() {}

func (x *UserSetting_RefreshTokensSetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_RefreshTokensSetting.ProtoReflect.Descriptor instead.
func (*UserSetting_RefreshTokensSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{11, 2}
}

func (x *UserSetting_RefreshTokensSetting) GetRefreshTokens() []*UserSetting_RefreshTokensSetting_RefreshToken {
	if x != nil {
...
type UserSetting_RefreshTokensSetting_RefreshToken struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	ClientInfo *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo `protobuf:"bytes,4,opt,name=client_info,json=clientInfo,proto3" json:"client_info,omitempty"`
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken) Reset() {
	*x = UserSetting_RefreshTokensSetting_RefreshToken{}
	mi := &file_api_v1_user_service_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_RefreshTokensSetting_RefreshToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_RefreshTokensSetting_RefreshToken) ProtoMessage() {}

func (x *UserSetting_RefreshTokensSetting_RefreshToken) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[44]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_RefreshTokensSetting_RefreshToken.ProtoReflect.Descriptor instead.
func (*UserSetting_RefreshTokensSetting_RefreshToken) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{11, 2, 0}
}

func (x *UserSetting_RefreshTokensSetting_RefreshToken) GetTokenId() string {
	if x != nil {
		return x.TokenId
	}
	return ""
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken) GetClientInfo() *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo {
	if x != nil {
		return x.ClientInfo
	}
	return nil
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
type UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) Reset() {
	*x = UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo{}
	mi := &file_api_v1_user_service_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) ProtoMessage() {}

func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo.ProtoReflect.Descriptor instead.
func (*UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{11, 2, 0, 0}
}

func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) GetDeviceType() string {
	if x != nil {
		return x.DeviceType
	}
	return ""
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) GetOs() string {
	if x != nil {
		return x.Os
	}
	return ""
...
func (x *UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo) GetBrowser() string {
	if x != nil {
		return x.Browser
	}
	return ""
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xee\t\n" +
	...
	"\x10webhooks_setting\x18\x05 \x01(\v2).memos.api.v1.UserSetting.WebhooksSettingH\x00R\x0fwebhooksSetting\x12f\n" +
	"\x16refresh_tokens_setting\x18\x06 \x01(\v2..memos.api.v1.UserSetting.RefreshTokensSettingH\x00R\x14refreshTokensSetting\x1av\n" +
	...
	"\bwebhooks\x18\x01 \x03(\v2\x19.memos.api.v1.UserWebhookR\bwebhooks\x1a\xbf\x04\n" +
	"\x14RefreshTokensSetting\x12b\n" +
	"\x0erefresh_tokens\x18\x01 \x03(\v2;.memos.api.v1.UserSetting.RefreshTokensSetting.RefreshTokenR\rrefreshTokens\x1a\xc2\x03\n" +
	...
	"\vclient_info\x18\x04 \x01(\v2F.memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfoR\n" +
	"clientInfo\x12 \n" +
	...
	"\abrowser\x18\x05 \x01(\tR\abrowser\"I\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\f\n" +
	"\bWEBHOOKS\x10\x04\x12\x12\n" +
	"\x0eREFRESH_TOKENS\x10\x06:Y\xeaAV\n" +
	...
	"\x1dmemos.api.v1/UserNotificationR\x04name2\x85\x1c\n" +
	"\vUserService\x12c\n" +
...
var file_api_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*LinkedIdentity)(nil),                                           // 20: memos.api.v1.LinkedIdentity
	(*ListLinkedIdentitiesRequest)(nil),                              // 21: memos.api.v1.ListLinkedIdentitiesRequest
	(*ListLinkedIdentitiesResponse)(nil),                             // 22: memos.api.v1.ListLinkedIdentitiesResponse
	(*CreateLinkedIdentityRequest)(nil),                              // 23: memos.api.v1.CreateLinkedIdentityRequest
	(*GetLinkedIdentityRequest)(nil),                                 // 24: memos.api.v1.GetLinkedIdentityRequest
	(*DeleteLinkedIdentityRequest)(nil),                              // 25: memos.api.v1.DeleteLinkedIdentityRequest
	(*PersonalAccessToken)(nil),                                      // 26: memos.api.v1.PersonalAccessToken
	(*ListPersonalAccessTokensRequest)(nil),                          // 27: memos.api.v1.ListPersonalAccessTokensRequest
	(*ListPersonalAccessTokensResponse)(nil),                         // 28: memos.api.v1.ListPersonalAccessTokensResponse
	(*CreatePersonalAccessTokenRequest)(nil),                         // 29: memos.api.v1.CreatePersonalAccessTokenRequest
	(*CreatePersonalAccessTokenResponse)(nil),                        // 30: memos.api.v1.CreatePersonalAccessTokenResponse
	(*DeletePersonalAccessTokenRequest)(nil),                         // 31: memos.api.v1.DeletePersonalAccessTokenRequest
	(*UserWebhook)(nil),                                              // 32: memos.api.v1.UserWebhook
	(*ListUserWebhooksRequest)(nil),                                  // 33: memos.api.v1.ListUserWebhooksRequest
	(*ListUserWebhooksResponse)(nil),                                 // 34: memos.api.v1.ListUserWebhooksResponse
	(*CreateUserWebhookRequest)(nil),                                 // 35: memos.api.v1.CreateUserWebhookRequest
	(*UpdateUserWebhookRequest)(nil),                                 // 36: memos.api.v1.UpdateUserWebhookRequest
	(*DeleteUserWebhookRequest)(nil),                                 // 37: memos.api.v1.DeleteUserWebhookRequest
	(*UserNotification)(nil),                                         // 38: memos.api.v1.UserNotification
	(*ListUserNotificationsRequest)(nil),                             // 39: memos.api.v1.ListUserNotificationsRequest
	(*ListUserNotificationsResponse)(nil),                            // 40: memos.api.v1.ListUserNotificationsResponse
	(*UpdateUserNotificationRequest)(nil),                            // 41: memos.api.v1.UpdateUserNotificationRequest
	(*DeleteUserNotificationRequest)(nil),                            // 42: memos.api.v1.DeleteUserNotificationRequest
	nil,                                                              // 43: memos.api.v1.UserStats.TagCountEntry
	(*UserStats_MemoTypeStats)(nil),                                  // 44: memos.api.v1.UserStats.MemoTypeStats
	(*UserSetting_GeneralSetting)(nil),                               // 45: memos.api.v1.UserSetting.GeneralSetting
	(*UserSetting_WebhooksSetting)(nil),                              // 46: memos.api.v1.UserSetting.WebhooksSetting
	(*UserSetting_RefreshTokensSetting)(nil),                         // 47: memos.api.v1.UserSetting.RefreshTokensSetting
	(*UserSetting_RefreshTokensSetting_RefreshToken)(nil),            // 48: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken
	(*UserSetting_RefreshTokensSetting_RefreshToken_ClientInfo)(nil), // 49: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo
	(State)(0),                    // 50: memos.api.v1.State
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	50, // 1: memos.api.v1.User.state:type_name -> memos.api.v1.State
	51, // 2: memos.api.v1.User.create_time:type_name -> google.protobuf.Timestamp
	51, // 3: memos.api.v1.User.update_time:type_name -> google.protobuf.Timestamp
	4,  // 4: memos.api.v1.ListUsersResponse.users:type_name -> memos.api.v1.User
	52, // 5: memos.api.v1.GetUserRequest.read_mask:type_name -> google.protobuf.FieldMask
	...
	52, // 8: memos.api.v1.UpdateUserRequest.update_mask:type_name -> google.protobuf.FieldMask
	51, // 9: memos.api.v1.UserStats.memo_display_timestamps:type_name -> google.protobuf.Timestamp
	44, // 10: memos.api.v1.UserStats.memo_type_stats:type_name -> memos.api.v1.UserStats.MemoTypeStats
	43, // 11: memos.api.v1.UserStats.tag_count:type_name -> memos.api.v1.UserStats.TagCountEntry
	11, // 12: memos.api.v1.ListAllUserStatsResponse.stats:type_name -> memos.api.v1.UserStats
	45, // 13: memos.api.v1.UserSetting.general_setting:type_name -> memos.api.v1.UserSetting.GeneralSetting
	46, // 14: memos.api.v1.UserSetting.webhooks_setting:type_name -> memos.api.v1.UserSetting.WebhooksSetting
	47, // 15: memos.api.v1.UserSetting.refresh_tokens_setting:type_name -> memos.api.v1.UserSetting.RefreshTokensSetting
	15, // 16: memos.api.v1.UpdateUserSettingRequest.setting:type_name -> memos.api.v1.UserSetting
	52, // 17: memos.api.v1.UpdateUserSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	15, // 18: memos.api.v1.ListUserSettingsResponse.settings:type_name -> memos.api.v1.UserSetting
	20, // 19: memos.api.v1.ListLinkedIdentitiesResponse.linked_identities:type_name -> memos.api.v1.LinkedIdentity
	51, // 20: memos.api.v1.PersonalAccessToken.created_at:type_name -> google.protobuf.Timestamp
	51, // 21: memos.api.v1.PersonalAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	51, // 22: memos.api.v1.PersonalAccessToken.last_used_at:type_name -> google.protobuf.Timestamp
	26, // 23: memos.api.v1.ListPersonalAccessTokensResponse.personal_access_tokens:type_name -> memos.api.v1.PersonalAccessToken
	26, // 24: memos.api.v1.CreatePersonalAccessTokenResponse.personal_access_token:type_name -> memos.api.v1.PersonalAccessToken
	51, // 25: memos.api.v1.UserWebhook.create_time:type_name -> google.protobuf.Timestamp
	51, // 26: memos.api.v1.UserWebhook.update_time:type_name -> google.protobuf.Timestamp
	32, // 27: memos.api.v1.ListUserWebhooksResponse.webhooks:type_name -> memos.api.v1.UserWebhook
	32, // 28: memos.api.v1.CreateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	32, // 29: memos.api.v1.UpdateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	52, // 30: memos.api.v1.UpdateUserWebhookRequest.update_mask:type_name -> google.protobuf.FieldMask
	2,  // 31: memos.api.v1.UserNotification.status:type_name -> memos.api.v1.UserNotification.Status
	51, // 32: memos.api.v1.UserNotification.create_time:type_name -> google.protobuf.Timestamp
	3,  // 33: memos.api.v1.UserNotification.type:type_name -> memos.api.v1.UserNotification.Type
	38, // 34: memos.api.v1.ListUserNotificationsResponse.notifications:type_name -> memos.api.v1.UserNotification
	38, // 35: memos.api.v1.UpdateUserNotificationRequest.notification:type_name -> memos.api.v1.UserNotification
	52, // 36: memos.api.v1.UpdateUserNotificationRequest.update_mask:type_name -> google.protobuf.FieldMask
	32, // 37: memos.api.v1.UserSetting.WebhooksSetting.webhooks:type_name -> memos.api.v1.UserWebhook
	48, // 38: memos.api.v1.UserSetting.RefreshTokensSetting.refresh_tokens:type_name -> memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken
	51, // 39: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.expires_at:type_name -> google.protobuf.Timestamp
	51, // 40: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.created_at:type_name -> google.protobuf.Timestamp
	49, // 41: memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.client_info:type_name -> memos.api.v1.UserSetting.RefreshTokensSetting.RefreshToken.ClientInfo
	5,  // 42: memos.api.v1.UserService.ListUsers:input_type -> memos.api.v1.ListUsersRequest
	7,  // 43: memos.api.v1.UserService.GetUser:input_type -> memos.api.v1.GetUserRequest
	8,  // 44: memos.api.v1.UserService.CreateUser:input_type -> memos.api.v1.CreateUserRequest
	9,  // 45: memos.api.v1.UserService.UpdateUser:input_type -> memos.api.v1.UpdateUserRequest
	10, // 46: memos.api.v1.UserService.DeleteUser:input_type -> memos.api.v1.DeleteUserRequest
	13, // 47: memos.api.v1.UserService.ListAllUserStats:input_type -> memos.api.v1.ListAllUserStatsRequest
	12, // 48: memos.api.v1.UserService.GetUserStats:input_type -> memos.api.v1.GetUserStatsRequest
	16, // 49: memos.api.v1.UserService.GetUserSetting:input_type -> memos.api.v1.GetUserSettingRequest
	17, // 50: memos.api.v1.UserService.UpdateUserSetting:input_type -> memos.api.v1.UpdateUserSettingRequest
	18, // 51: memos.api.v1.UserService.ListUserSettings:input_type -> memos.api.v1.ListUserSettingsRequest
	21, // 52: memos.api.v1.UserService.ListLinkedIdentities:input_type -> memos.api.v1.ListLinkedIdentitiesRequest
	23, // 53: memos.api.v1.UserService.CreateLinkedIdentity:input_type -> memos.api.v1.CreateLinkedIdentityRequest
	24, // 54: memos.api.v1.UserService.GetLinkedIdentity:input_type -> memos.api.v1.GetLinkedIdentityRequest
	25, // 55: memos.api.v1.UserService.DeleteLinkedIdentity:input_type -> memos.api.v1.DeleteLinkedIdentityRequest
	27, // 56: memos.api.v1.UserService.ListPersonalAccessTokens:input_type -> memos.api.v1.ListPersonalAccessTokensRequest
	29, // 57: memos.api.v1.UserService.CreatePersonalAccessToken:input_type -> memos.api.v1.CreatePersonalAccessTokenRequest
	31, // 58: memos.api.v1.UserService.DeletePersonalAccessToken:input_type -> memos.api.v1.DeletePersonalAccessTokenRequest
	33, // 59: memos.api.v1.UserService.ListUserWebhooks:input_type -> memos.api.v1.ListUserWebhooksRequest
	35, // 60: memos.api.v1.UserService.CreateUserWebhook:input_type -> memos.api.v1.CreateUserWebhookRequest
	36, // 61: memos.api.v1.UserService.UpdateUserWebhook:input_type -> memos.api.v1.UpdateUserWebhookRequest
	37, // 62: memos.api.v1.UserService.DeleteUserWebhook:input_type -> memos.api.v1.DeleteUserWebhookRequest
	39, // 63: memos.api.v1.UserService.ListUserNotifications:input_type -> memos.api.v1.ListUserNotificationsRequest
	41, // 64: memos.api.v1.UserService.UpdateUserNotification:input_type -> memos.api.v1.UpdateUserNotificationRequest
	42, // 65: memos.api.v1.UserService.DeleteUserNotification:input_type -> memos.api.v1.DeleteUserNotificationRequest
	...
	53, // 70: memos.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	...
	22, // 76: memos.api.v1.UserService.ListLinkedIdentities:output_type -> memos.api.v1.ListLinkedIdentitiesResponse
	20, // 77: memos.api.v1.UserService.CreateLinkedIdentity:output_type -> memos.api.v1.LinkedIdentity
	20, // 78: memos.api.v1.UserService.GetLinkedIdentity:output_type -> memos.api.v1.LinkedIdentity
	53, // 79: memos.api.v1.UserService.DeleteLinkedIdentity:output_type -> google.protobuf.Empty
	28, // 80: memos.api.v1.UserService.ListPersonalAccessTokens:output_type -> memos.api.v1.ListPersonalAccessTokensResponse
	30, // 81: memos.api.v1.UserService.CreatePersonalAccessToken:output_type -> memos.api.v1.CreatePersonalAccessTokenResponse
	53, // 82: memos.api.v1.UserService.DeletePersonalAccessToken:output_type -> google.protobuf.Empty
	34, // 83: memos.api.v1.UserService.ListUserWebhooks:output_type -> memos.api.v1.ListUserWebhooksResponse
	32, // 84: memos.api.v1.UserService.CreateUserWebhook:output_type -> memos.api.v1.UserWebhook
	32, // 85: memos.api.v1.UserService.UpdateUserWebhook:output_type -> memos.api.v1.UserWebhook
	53, // 86: memos.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
	40, // 87: memos.api.v1.UserService.ListUserNotifications:output_type -> memos.api.v1.ListUserNotificationsResponse
	38, // 88: memos.api.v1.UserService.UpdateUserNotification:output_type -> memos.api.v1.UserNotification
	53, // 89: memos.api.v1.UserService.DeleteUserNotification:output_type -> google.protobuf.Empty
...
func file_api_v1_user_service_proto_init() {
	...
	file_api_v1_user_service_proto_msgTypes[11].OneofWrappers = []any{
		...
		(*UserSetting_RefreshTokensSetting_)(nil),
	}
	file_api_v1_user_service_proto_msgTypes[34].OneofWrappers = []any{}
	type x struct{}
